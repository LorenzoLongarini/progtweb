<?php $__env->startSection('event-content'); ?>
...
<div class="hero flex-center"> 
    <div class="container flex-rows">
        <div class="content-hero">
            <h2>Tour Artista</h2>
            <h3>24 giu 2022</h3>
            <h3>Milano, San Siro</h3>
        </div>
        <div class="btn-hero">
            <button class="default-btn">Acquista ora</button>
        </div>
    </div>
</div>
<div class="hero flex-center"> 
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/progettoweb21/laraProject/resources/views/event.blade.php ENDPATH**/ ?>