<head>
        <title><?php echo $__env->yieldContent('title', 'Un click per divertirsi'); ?> | EasyTickets</title>
        <meta charset="UTF-8">
        ...
        <meta name="author" content="Gruppo_11">
        ...
        <script src="<?php echo e(asset('js/credit-card.js')); ?>"></script>
        <script src="<?php echo e(asset('js/slider.js')); ?>"></script>
        <script src="<?php echo e(asset('js/slider-auto.js')); ?>"></script>
        <script src="<?php echo e(asset('js/theme.js')); ?>"></script>
    </head><?php /**PATH /Applications/MAMP/htdocs/progettoweb21/laraProject/resources/views/includes/head.blade.php ENDPATH**/ ?>