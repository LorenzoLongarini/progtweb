...
{{ link_to_route('insert-staff', 'AGGIUNGI',  $parameters = [], ['class'=>'user-btn', 'style' => 'width: 150px;
    margin-left: 400px;'])}}
...
@foreach($staff as $staf)
        ...
        <div class = "utenti-liv-2" style = " padding: 0px 25px; width: 950px;">
            ...
            <div>
            {{ link_to_route('modifica-staff', 'MODIFICA', $parameters = ['usersId' => $staf->usersId], ['class'=>'user-btn'] )}}
            </div>
</div>
            </div>
            </div>
