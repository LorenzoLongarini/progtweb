...
<div class="container img-presentation">
    @include('helpers/cover-page', [
                'title' => 'DL Computers, Assistenza in tutta Italia', 
                'description' => 'Contatta uno dei nostri centri assistenza per maggiori informazioni',
                'img_url' => '../public/images/white.jpg'])
